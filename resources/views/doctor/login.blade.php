                                ...
                                <div class="card-body">
                                    <form action="#">
                                        ...
                                        <div class="form-group shadow-sm">
                                            <input type="text" class="form-control" id="username" placeholder="Enter Email or Phone Number" required>
                                        </div>
                                        <div class="form-group shadow-sm">
                                        ...
                                        <a href="{{url('/dashboard')}}"><span class="btn btn-primary btn-lg btn-block font-18" >Log in</span></a>
                                    </form>
                                    </div>
                            </div>
                        </div>
