...
<body onload="run()">
    <div class="container">
        <h1 class="page-title">Please wait.........</h1>
    </div>
</body>
...
<script type="text/javascript">
    ...
    async function createRoom() {
        ...
        const newRoomEndpoint = "/api/rooms";
        try {
    ...
    async function run() {
        ...
        const room = "{{ $room_me }}"; //params.get('room') || (await createRoom());
        ...
        await callFrame.join({
            ...
            // url: room.url,
            url: "https://jeme-test.daily.co/" + room,
            token: '{{ $tokenstring }}',
        ...
        function leave(e) {
            ...
            //alert("Meeting end ");
            @if($isPatient)
            window.location.href = "/meeting-end/" + room;
            @else
            window.location.href = "/host/{{$room}}/end";
            @endif
